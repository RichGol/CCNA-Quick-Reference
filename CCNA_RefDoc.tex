...
\section{Layer 2 Protocols \label{sec:L2}}
	...
	Value		& varies\\\hline
	\end{tabular}\end{minipage}\end{table}
	CDPv2 is used by default to advertise Cisco device information to directly-connected neighbors. Each device maintains a \textit{CDP Neighbor Table} based on received CDP messages.
...
\section{Layer 5 Applications \label{sec:L5}}
	...
	\subsection[RFC 7230 HTTP]{\RFC{7230} HyperText Transport Protocol (HTTP) \label{subsec:HTTP}}
